...
@section('content')
    <div class="container-fluid d-none h-100" id='public-grasslands'>
        <div class="d-flex flex-column h-100">
            ...
            {{-- Компонент сообщений --}}
            {{-- ********************** --}}
            <messages-component :_messages='messages' v-on:cancel-msg='cancelConfirmActionCb'
                v-on:confirm-msg='confirmActionCb' v-on:clear-msg='clearMessages'></messages-component>
            {{-- ********************** --}}
            ...
            <div class="h-100 position-relative" v-show='mode === "list" || mode === "details" '>
                <Transition name="fade">
                    <div class="p-3 align-self-start" v-if='mode === "list" || mode === "details" '>
                        <div class="row h-100">
